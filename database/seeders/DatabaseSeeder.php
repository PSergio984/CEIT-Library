    ...
    public function run(): void
    {
        ...
        foreach ($activeBatchStudents as $student) {
            Librarian::create([
                ...
                'batch_no' => 1,
                'start_date' => $today,
                'end_date' => null, // No end date set yet
                'status' => 'active',
                'date_start' => $today,
                'expires_at' => null,
                'created_by' => $admin->id,
        ...
        foreach ($expiredBatch1Students as $student) {
            Librarian::create([
                ...
                'status' => 'expired',
                'date_start' => $today->copy()->subDays(10),
                'expires_at' => $today->copy()->subDays(3),
                'created_by' => $admin->id,
        ...
        foreach ($expiredBatch2Students as $student) {
            Librarian::create([
                ...
                'status' => 'expired',
                'date_start' => $today->copy()->subDays(20),
                'expires_at' => $today->copy()->subDays(7),
                'created_by' => $admin->id,
        ...
        foreach ($inactiveBatch1Students as $student) {
            Librarian::create([
                ...
                'end_date' => null,
                'status' => 'inactive',
                'date_start' => $today->copy()->addDays(2),
                'expires_at' => null,
                'created_by' => $admin->id,
                'created_at' => now(),
                'updated_at' => now(),
        ...
        foreach ($inactiveBatch2Students as $student) {
            Librarian::create([
                ...
                'end_date' => null,
                'status' => 'inactive',
                'date_start' => $today->copy()->addDays(5),
                'expires_at' => null,
                'created_by' => $admin->id,
                'created_at' => now(),
                'updated_at' => now(),
        ...
        foreach ($inactiveBatch3Students as $student) {
            Librarian::create([
                ...
                'end_date' => null,
                'status' => 'inactive',
                'date_start' => $today->copy()->addDays(7),
                'expires_at' => null,
                'created_by' => $admin->id,
                'created_at' => now(),
                'updated_at' => now(),
