        ...
        <x-mary-form wire:submit="register">
            ...
            <div class="mb-4">
                <x-mary-input
                    ...
                    icon-class="!text-gray-700"
                    error-field="email" />
                <p class="text-xs text-gray-600 mt-1">Email is auto-generated from your name</p>
            </div>
            ...
            <div class="mb-4">
                ...
                <div class="mt-3 space-y-1">
                    ...
                    <div class="flex items-center gap-2">
                        <svg class="w-4 h-4" :class="requirements.length ? 'text-green-600' : 'text-gray-400'" fill="currentColor" viewBox="0 0 20 20">
                    ...
                    <div class="flex items-center gap-2">
                        <svg class="w-4 h-4" :class="requirements.uppercase ? 'text-green-600' : 'text-gray-400'" fill="currentColor" viewBox="0 0 20 20">
                            <path fill-rule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clip-rule="evenodd" />
                        </svg>
                        <span class="text-xs" :class="requirements.uppercase ? 'text-gray-700' : 'text-gray-500'">One uppercase letter</span>
                    </div>
                    <div class="flex items-center gap-2">
                        <svg class="w-4 h-4" :class="requirements.number ? 'text-green-600' : 'text-gray-400'" fill="currentColor" viewBox="0 0 20 20">
                            <path fill-rule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clip-rule="evenodd" />
                        </svg>
                        <span class="text-xs" :class="requirements.number ? 'text-gray-700' : 'text-gray-500'">One number</span>
                    </div>
                    <div class="flex items-center gap-2">
                        <svg class="w-4 h-4" :class="requirements.symbol ? 'text-green-600' : 'text-gray-400'" fill="currentColor" viewBox="0 0 20 20">
                            <path fill-rule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clip-rule="evenodd" />
                        </svg>
