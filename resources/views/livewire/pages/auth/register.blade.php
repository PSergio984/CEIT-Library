        ...
        <x-mary-form wire:submit="register">
            ...
            <div class="mb-4">
                ...
                <template x-if="touched.first_name && errors.first_name && !$wire.__instance.snapshot.memo.errors?.first_name">
                    <p class="text-red-600 dark:text-red-400 text-xs mt-1" x-text="errors.first_name"></p>
                </template>
            </div>
            ...
            <div class="mb-4">
                ...
                <template x-if="touched.last_name && errors.last_name && !$wire.__instance.snapshot.memo.errors?.last_name">
                    <p class="text-red-600 dark:text-red-400 text-xs mt-1" x-text="errors.last_name"></p>
                </template>
            </div>
            ...
            <div class="mb-4">
                ...
                <p class="text-xs text-slate-700 dark:text-slate-300 mt-1">Email is suggested from your name but you can edit it</p>
            ...
            <div class="mb-4">
                ...
                <div class="mt-2" role="status" aria-live="polite">
                    <div class="flex items-center justify-between mb-1">
                        <span class="text-xs text-slate-700 dark:text-slate-300">Password Strength:</span>
                        <span class="text-xs font-semibold"
                              :class="{
                                  'text-red-600 dark:text-red-400': passwordLabel === 'Weak',
                                  'text-orange-600 dark:text-orange-400': passwordLabel === 'Fair',
                                  'text-yellow-600 dark:text-yellow-400': passwordLabel === 'Good',
                                  'text-green-600 dark:text-green-400': passwordLabel === 'Strong'
                              }"
                              x-text="passwordLabel"></span>
                    </div>
                    <div class="w-full bg-gray-300 dark:bg-slate-700 rounded-full h-2" role="progressbar" :aria-valuenow="passwordStrength" aria-valuemin="0" aria-valuemax="100" :aria-label="'Password strength: ' + passwordLabel">
                        <div class="h-2 rounded-full transition-all duration-300"
                             :class="{
                                  'bg-red-500 dark:bg-red-400': passwordLabel === 'Weak',
                                  'bg-orange-500 dark:bg-orange-400': passwordLabel === 'Fair',
                                  'bg-yellow-500 dark:bg-yellow-400': passwordLabel === 'Good',
                                  'bg-green-500 dark:bg-green-400': passwordLabel === 'Strong'
                             }"
                ...
                <div class="mt-3 space-y-1">
                    ...
                    <div class="flex items-center gap-2">
                        <svg class="w-4 h-4" :class="requirements.length ? 'text-green-600 dark:text-green-400' : 'text-gray-400 dark:text-slate-600'" fill="currentColor" viewBox="0 0 20 20" aria-hidden="true">
                            <path fill-rule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clip-rule="evenodd" />
                        </svg>
                        <span class="text-xs" :class="requirements.length ? 'text-slate-800 dark:text-slate-200 font-medium' : 'text-slate-500 dark:text-slate-400'">At least 8 characters</span>
                    </div>
                    <div class="flex items-center gap-2">
                        <svg class="w-4 h-4" :class="requirements.uppercase ? 'text-green-600 dark:text-green-400' : 'text-gray-400 dark:text-slate-600'" fill="currentColor" viewBox="0 0 20 20" aria-hidden="true">
                            <path fill-rule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clip-rule="evenodd" />
                        </svg>
                        <span class="text-xs" :class="requirements.uppercase ? 'text-slate-800 dark:text-slate-200 font-medium' : 'text-slate-500 dark:text-slate-400'">One uppercase letter</span>
                    </div>
                    <div class="flex items-center gap-2">
                        <svg class="w-4 h-4" :class="requirements.lowercase ? 'text-green-600 dark:text-green-400' : 'text-gray-400 dark:text-slate-600'" fill="currentColor" viewBox="0 0 20 20" aria-hidden="true">
                            <path fill-rule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clip-rule="evenodd" />
                        </svg>
                        <span class="text-xs" :class="requirements.lowercase ? 'text-slate-800 dark:text-slate-200 font-medium' : 'text-slate-500 dark:text-slate-400'">One lowercase letter</span>
                    </div>
                    <div class="flex items-center gap-2">
                        <svg class="w-4 h-4" :class="requirements.number ? 'text-green-600 dark:text-green-400' : 'text-gray-400 dark:text-slate-600'" fill="currentColor" viewBox="0 0 20 20" aria-hidden="true">
                            <path fill-rule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clip-rule="evenodd" />
                        </svg>
                        <span class="text-xs" :class="requirements.number ? 'text-slate-800 dark:text-slate-200 font-medium' : 'text-slate-500 dark:text-slate-400'">One number</span>
                    </div>
                    <div class="flex items-center gap-2">
                        <svg class="w-4 h-4" :class="requirements.symbol ? 'text-green-600 dark:text-green-400' : 'text-gray-400 dark:text-slate-600'" fill="currentColor" viewBox="0 0 20 20" aria-hidden="true">
                            <path fill-rule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clip-rule="evenodd" />
                        </svg>
                        <span class="text-xs" :class="requirements.symbol ? 'text-slate-800 dark:text-slate-200 font-medium' : 'text-slate-500 dark:text-slate-400'">One special character (!@#$%^&*(),.?":{}|<>)</span>
                    </div>
                </div>
            </div>
