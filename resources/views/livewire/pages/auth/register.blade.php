...
new #[Layout('layouts.guest')] class extends Component
{
    ...
    public function register(): void
    {
        $validated = $this->validate([
            ...
            'student_no' => ['required', 'string', 'size:7', 'regex:/^\d{2}-\d{4}$/'],
...
<div class="relative w-full max-w-xs sm:max-w-sm md:max-w-md lg:max-w-lg xl:max-w-2xl mx-auto">
    ...
    <div class="relative z-20">
        <div class="bg-[#273F4F] h-16 sm:h-20 md:h-24 rounded-b-xl sm:rounded-b-2xl flex items-center justify-center overflow-hidden">
            <div class="absolute left-1/2 top-12 sm:top-16 md:top-20 transform -translate-x-1/2 -translate-y-1/2 z-20">
                <img src="{{ asset('images/ceit-logo.png') }}" alt="Description of image" class="w-12 h-12 sm:w-16 sm:h-16 md:w-20 md:h-20 rounded-full border-2 sm:border-3 md:border-4 border-[#D9D9D9] bg-white shadow-lg object-contain">
            </div>
        </div>
        <!-- More aggressive bottom curve -->
        <div class="w-full h-12 sm:h-16 md:h-20 bg-[#273F4F] rounded-b-[100px] sm:rounded-b-[150px] md:rounded-b-[200px] -mt-6 sm:-mt-8 md:-mt-10"></div>
    </div>
    <!-- Card Body -->
    <div class="bg-[#D9D9D9] rounded-b-xl sm:rounded-b-2xl pt-12 sm:pt-16 md:pt-20 pb-8 sm:pb-10 md:pb-12 px-4 sm:px-8 md:px-10 lg:px-14 shadow-2xl -mt-4 sm:-mt-6 md:-mt-8 relative z-10">
        <!-- Title -->
        <h2 class="text-lg sm:text-xl md:text-2xl font-semibold text-gray-800 text-center mb-4 sm:mb-6 md:mb-8">Create your account</h2>
