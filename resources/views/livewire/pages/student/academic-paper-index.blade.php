...
<div>
    <div class="p-6">
        ...
        <div x-data="{ 
            showFilters: true,
            hasActiveFilters: @entangle('statusFilter') || @entangle('paperTypeFilter') || @entangle('departmentFilter') || @entangle('yearFromFilter') || @entangle('yearToFilter')
        }" class="mb-6">
        ...
        </div>            {{-- Collapsible Filter Section --}}
            <div 
                x-show="showFilters" 
