                        ...
                        <div class="flex-1">
                            <div class="flex items-start gap-2 mb-2">
                                @if($notification->type === 'system')
                                    <x-mary-icon name="o-cog" class="w-5 h-5 text-info flex-shrink-0 mt-0.5" />
                                @elseif($notification->type === 'user_activity')
                                    <x-mary-icon name="o-user-group" class="w-5 h-5 text-success flex-shrink-0 mt-0.5" />
                                @elseif($notification->type === 'violation')
                                    <x-mary-icon name="o-exclamation-triangle" class="w-5 h-5 text-error flex-shrink-0 mt-0.5" />
